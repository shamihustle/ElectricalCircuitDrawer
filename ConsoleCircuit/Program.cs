...
#region
                ...
                Console.WriteLine("R = " + r.CalculateZ(12));
                Console.WriteLine("C = " + c.CalculateZ(12));
                Console.WriteLine("I = " + i.CalculateZ(12));
                ...
                s1.AddComponent(p1);
                Console.WriteLine("P1 = " + p1.CalculateZ(12));
                Console.WriteLine("Z = " + s1.CalculateZ(12) +  "\n");
#endregion
            }
